...
This repository is a small personal extension study for **low-dose CT (LDCT) denoising** based on **DU-GAN**.

> **Original DU-GAN authors (primary credit):**  
> Zhizhong Huang, Junping Zhang, Yi Zhang, Hongming Shan  
> Paper: [DU-GAN: Generative Adversarial Networks with Dual-Domain U-Net Based Discriminators for Low-Dose CT Denoising](https://arxiv.org/abs/2108.10772)

> **Authorship notice**  
> I am **not** the original author of DU-GAN.  
> This repository is only a small independent research/reproduction branch built on top of the published DU-GAN paper and its open-source implementation, with additional personal experiments (for example, Noise Discriminator and MoE-related ideas).
